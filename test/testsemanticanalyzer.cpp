...
DEFINE_SEMANTICANALYZER_TEST(TypeEvaluationErrors, "scripts/sanalyzer_TypeEvaluationErrors.bond")
{
	const TestFramework::ExpectedParseError EXPECTED_ERRORS[] =
	{
		...
		{Bond::ParseError::ParseError::INVALID_TYPE_FOR_OPERATOR, Bond::Token::OP_BIT_AND, 39},
		{Bond::ParseError::ParseError::INVALID_TYPE_FOR_OPERATOR, Bond::Token::OP_BIT_AND, 39},
		...
		{Bond::ParseError::ParseError::INVALID_TYPE_FOR_POINTER_OPERATOR, Bond::Token::OP_MULT, 43},
