...
#define BOND_OPCODE_LIST \
	...
	BOND_OPCODE_ITEM(PUSH32_P0,  push32_p0)  \
	BOND_OPCODE_ITEM(PUSH32_P1,  push32_p1)  \
	BOND_OPCODE_ITEM(PUSH32_P2,  push32_p2)  \
	BOND_OPCODE_ITEM(PUSH32_P3,  push32_p3)  \
	BOND_OPCODE_ITEM(PUSH32_L0,  push32_l0)  \
	BOND_OPCODE_ITEM(PUSH32_L1,  push32_l1)  \
	BOND_OPCODE_ITEM(PUSH32_L2,  push32_l2)  \
	BOND_OPCODE_ITEM(PUSH32_L3,  push32_l3)  \
	BOND_OPCODE_ITEM(PUSH64,     push64)     \
	BOND_OPCODE_ITEM(PUSH64W,    push64w)    \
	BOND_OPCODE_ITEM(PUSH64_P0,  push64_p0)  \
	BOND_OPCODE_ITEM(PUSH64_P1,  push64_p1)  \
	BOND_OPCODE_ITEM(PUSH64_P2,  push64_p2)  \
	BOND_OPCODE_ITEM(PUSH64_P3,  push64_p3)  \
	BOND_OPCODE_ITEM(PUSH64_L0,  push64_l0)  \
	BOND_OPCODE_ITEM(PUSH64_L1,  push64_l1)  \
	BOND_OPCODE_ITEM(PUSH64_L2,  push64_l2)  \
	BOND_OPCODE_ITEM(PUSH64_L3,  push64_l3)  \
	                                         \
	...
	BOND_OPCODE_ITEM(POP32_P0,   pop32_p0)   \
	BOND_OPCODE_ITEM(POP32_P1,   pop32_p1)   \
	BOND_OPCODE_ITEM(POP32_P2,   pop32_p2)   \
	BOND_OPCODE_ITEM(POP32_P3,   pop32_p3)   \
	...
	BOND_OPCODE_ITEM(POP64_P0,   pop64_p0)   \
	BOND_OPCODE_ITEM(POP64_P1,   pop64_p1)   \
	BOND_OPCODE_ITEM(POP64_P2,   pop64_p2)   \
	BOND_OPCODE_ITEM(POP64_P3,   pop64_p3)   \
